...
Contributors: ClickCease 
Tags: fraud protection, bot protection, website protection, click fraud, clickcease
...
3. Enter your ClickCease API keys in the plugin settings.
4. Click "Save" to enable protection.
...
= 3.2.13
* Minor updates: script ref updated.

= 3.2.12
* Upgraded min support version.
